...
[bpredict , ~ , zpredict , zcnv, cpredict , mline , msample , mcnv , mgrade , ...
    ...
    'psz', psz, 'nopts', nopts, 'tolfun', tolfun, 'tolx', tolx, ...
    'par', par, 'vis', vis);
...
% ---------------------------------------------------------------------------- %
%% Output
init = struct('z', zinit, 'c', cinit, 'm', minit, 'b', binit); % Initial Guesses
opt  = struct('z', zopt,  'c', copt,  'm', mopt,  'b', bopt);  % Optimized
