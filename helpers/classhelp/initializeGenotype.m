...
% This function parses through input and determines what Genotype object to create from that input. 
% The resulting Genotype object will be prepped for using it's own methods the load and process
% data. 
%
% Usage:
