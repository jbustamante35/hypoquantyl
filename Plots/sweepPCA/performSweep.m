...
% and down from the mean PC score (1 step = 1 standard deviation from the mean).
%
...
%   pcaX has 2 PCs, pcaY has 5 PCs --> figure(1) will have 2 subplots, figure(2) will have 5 subplots,
