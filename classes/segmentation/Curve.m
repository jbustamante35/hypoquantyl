...
classdef Curve < handle
    ...
    methods (Access = public)
        ...
        switch req
            ...
            case 'intrp'
                trc           = obj.Parent.InterpOutline;
                obj.TraceSize = size(trc, 1);
                
            case 'repos'
                %                     trc           = obj.Parent.FullOutline;
                trc           = obj.Parent.NormalizeOutline;
                obj.TraceSize = size(trc, 1);
        ...
        function [obj , mline , skl] = setRawMidline(obj, mline, typ)
    ...
    methods (Access = private)
        ...
        obj.RawSegments      = split2Segments( ...
            trace, segment_length, step_size, 1, obj.TOCENTER);
