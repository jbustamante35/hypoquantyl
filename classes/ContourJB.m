...
classdef ContourJB < handle
    ...
    methods (Access = public)
        ...
        function obj = ReindexCoordinates(obj)
            ...
            [obj.AnchorPoint, obj.AnchorIndex] = ...
                findAnchorPoint(obj, obj.InterpOutline);
    ...
    methods (Access = private)
        ...
        function [apt, idx] = findAnchorPoint(obj, crds, alg)
            ...
            if nargin > 2
                ...
                % Get range of coordinates at lowest row
                idx = 1;
        ...
        function shft = repositionPoints(obj, crds, idx)
            %% Re-index and Re-Center around AnchorPoint coordinate
            subt = crds - crds(idx,:);
