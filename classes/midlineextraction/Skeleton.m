...
classdef Skeleton < handle
    ...
    methods (Access = public)
        ...
        function obj = Contour2Skeleton(obj, cntr)
            ...
            if nargin < 2; cntr = obj.Contour; end
        ...
        function obj = FindRoutesFromStartPoint(obj)
            ...
            if isempty(obj.StartPoint); obj.FindStartPoint; end
    ...
    methods (Access = public)
        ...
        function j = getJoint(obj, jIdx)
            %% Return Joint object
            if nargin < 2; jIdx = 1 : obj.TotalJoints; end
        ...
        function setJoint(obj, j, jIdx)
            ...
            if nargin < 3; jIdx = obj.TotalJoints + 1; end
        ...
        function b = getBone(obj, bIdx)
            %% Return Bone object
            if nargin < 2; bIdx = 1 : obj.TotalBones; end
        ...
        function [P , pd] = sampleImage(obj, crds, edst)
            ...
            if nargin < 3; edst = obj.ENVELOPEDISTANCE; end
