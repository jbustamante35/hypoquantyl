    ...
    if v
        ...
        for i  = 1 : e.Genotypes(1).Seedlings(1).getLifetime
            if i <= e.Genotypes(1).Seedlings(1).getLifetime
                subplot(131), imagesc(e.Genotypes(1).Seedlings(1).getImageData(i, 'Image_gray')), colormap gray, axis image, title(sprintf('Seedling %s, Frame %d', e.Genotypes(1).Seedlings(1).getSeedlingName, i));
...
%                 subplot(333), imagesc(e.Genotypes(1).Seedlings(1).getImageData(i, 'Skeleton')), colormap gray, axis image, title(sprintf('Seedling %s, Frame %d', e.Genotypes(1).Seedlings(1).getSeedlingName, i));
            ...
            if i <= e.Genotypes(1).Seedlings(2).getLifetime
                subplot(132), imagesc(e.Genotypes(1).Seedlings(2).getImageData(i, 'Image_gray')), colormap gray, axis image, title(sprintf('Seedling %s, Frame %d', e.Genotypes(1).Seedlings(2).getSeedlingName, i));
...
%                 subplot(336), imagesc(e.Genotypes(1).Seedlings(2).getImageData(i, 'Skeleton')), colormap gray, axis image, title(sprintf('Seedling %s, Frame %d', e.Genotypes(1).Seedlings(2).getSeedlingName, i));
            ...
            if i <= e.Genotypes(1).Seedlings(3).getLifetime
                subplot(133), imagesc(e.Genotypes(1).Seedlings(3).getImageData(i, 'Image_gray')), colormap gray, axis image, title(sprintf('Seedling %s, Frame %d', e.Genotypes(1).Seedlings(3).getSeedlingName, i));                
